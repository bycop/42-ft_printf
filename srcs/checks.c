...
/*   Updated: 2020/12/17 13:41:12 by bycop         ###   ########lyon.fr   */
/*                                                                            */
/* ************************************************************************** */

#include "ft_printf.h"

t_global	extens(long int prec, t_global infos, int *ind, int type)
{
	if (type == 1)
	{
		*ind += 1;
...
t_global	flagpnbr(const char *str, t_global infos, int *ind, va_list va)
{
	int			i;
	char		*nbr;
...
t_global	check_prec(const char *str, t_global infos, int *ind, va_list va)
{
	int		i;
	char	*nbr;
